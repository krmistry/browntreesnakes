...
generate_fun <- function(t_minus_1,# The previous time step data (1 row, 4 columns for each size class)
  ...
  t <- vector() 
  # Calculate small class population (if population is 0 or negative, set to 0)
  ...
  # Calculate medium class population (if population is 0 or negative, set to 0)
  ...
  # Calculate large class population (if population is 0 or negative, set to 0)
  ...
  # Calculate x-large class population (if population is 0 or negative, set to 0)
...
ggplot(tm_plot, aes(fill = size, y = pop, x = time_step)) +
...
```{r starting_pop}
# Starting population list to iterate over (10 choices)
N_options <- seq(500, 7500, 750)
