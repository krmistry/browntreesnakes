...
# Total number of females with follicles
total_follicles <- length(nafus_data$IPM$fec.fol[nafus_data$IPM$fec.fol != 0])
# Total number of females traced to juveniles
total_juveniles <- length(nafus_data$IPM$fec.juv[nafus_data$IPM$fec.juv != 0])
offspring_mom_size <- list()
offspring_mom_size$follicles <- vector()
offspring_mom_size$juveniles <- vector()
if(nafus_data$IPM$fec.fol != 0) {
...
saveRDS(rates_list, file = "Data/vital_rates_lit.rds")
